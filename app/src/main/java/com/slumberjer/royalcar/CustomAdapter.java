...
public class CustomAdapter extends SimpleAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try{
            if(convertView==null)
                vi = inflater.inflate(R.layout.cust_list_company, null);
            HashMap<String, Object> data = (HashMap<String, Object>) getItem(position);
            TextView tvcompanyname = vi.findViewById(R.id.textView);
            ...
            ImageView imgcompany =vi.findViewById(R.id.imageView2);
            ...
            String dcid=(String) data.get("companyid");
            tvcompanyname.setText(dname);
            tvphone.setText(dphone);
            tvadd.setText(dadd);
            tvloc.setText(dloc);

            String image_url = "https://royalcar.000webhostapp.com/royalcar/images/"+dcid+".jpg";

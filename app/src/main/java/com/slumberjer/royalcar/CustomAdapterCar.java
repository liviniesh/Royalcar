...
public class CustomAdapterCar extends SimpleAdapter {

    private Context mContext;
    public LayoutInflater inflater=null;
    public CustomAdapterCar(Context context, List<? extends Map<String, ?>> data, int resource, String[] from, int[] to) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try{
            if(convertView==null)
                vi = inflater.inflate(R.layout.car_list_company, null);
            ...
            String did=(String) data.get("carid");

            tvcarname.setText(dcarname);
            tvrentalperhour.setText(drentalperhour);
            tvhours.setText(dhours);
            String image_url = "https://royalcar.000webhostapp.com/royalcar/carimages/"+did+".jpg";

...
if ($signed === $data['x_signature']) {
    ...
    if ($paidstatus == "Success"){
        ...
        $sqlupdate = "UPDATE CART SET STATUS = '$status' WHERE USERID = '$userid' AND ORDERID='$orderid'";
        $conn->query($sqlupdate);
        $sqlinsert = "INSERT INTO ORDERED(ORDERID,USERID,TOTAL) VALUES ('$orderid','$userid','$amount')";
